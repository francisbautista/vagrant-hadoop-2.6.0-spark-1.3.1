vagrant-hadoop-2.6.0-spark-1.3.1
================================

# Introduction

Vagrant project to spin up a cluster of 4 virtual machines with Hadoop v2.6.0 and Spark v1.3.1.
...
2. /resources/spark-1.3.1-bin-hadoop2.6.tgz
...
# References
This project was put together with great pointers from all around the internet. All references made inside the files themselves. Primaily this project is forked from Jee Vang's vagrant project (https://github.com/vangj/vagrant-hadoop-2.4.1-spark-1.0.1)

# Copyright Stuff
Copyright 2014 Francis Bautista
